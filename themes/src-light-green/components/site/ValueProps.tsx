      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-6">
        {items.map((it) => (
          <div key={it.title} className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#EFF0EB" }}>
              <it.icon className="h-5 w-5" style={{ color: "#355E4B" }} />
            </div>
            <div>
