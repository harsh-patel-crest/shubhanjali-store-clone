    ...
    <>
      ...
      >
        <div className="bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden h-[480px]">
          {/* Header */}
          <div className="px-4 py-3 flex items-center justify-between flex-shrink-0" style={{ backgroundColor: "#355E4B", color: "#FFFFFF" }}>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.map((m, i) => (
              <div key={i} className={`flex gap-2 ${m.role === "user" ? "flex-row-reverse" : "flex-row"}`}>
                <div
                  ...
                  style={m.role === "user"
                    ? { backgroundColor: "#355E4B", color: "#FFFFFF" }
                ...
                <div
                  ...
                  style={m.role === "user"
                    ? { backgroundColor: "#355E4B", color: "#FFFFFF", borderTopRightRadius: "0.25rem" }
                    : { backgroundColor: "#EFF0EB", color: "#1D1D1D", borderTopLeftRadius: "0.25rem" }
                  }
                >
                  {m.text}
                </div>
            ...
            {loading && (
              <div className="flex gap-2">
                <div className="h-7 w-7 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#EFF0EB" }}>
                  <Bot className="h-4 w-4" />
                </div>
                <div className="rounded-2xl rounded-tl-sm px-4 py-3" style={{ backgroundColor: "#EFF0EB" }}>
          ...
          <div className="border-t border-border p-3 flex gap-2 flex-shrink-0">
            ...
            <button
              ...
              onMouseOver={e => { if (!loading && input.trim()) e.currentTarget.style.backgroundColor = "#234236"; }}
