              ...
              >
                ...
                >
                  <div className="relative aspect-square overflow-hidden bg-secondary">
                    ...
                    />
                    {p.tag && (
                      <span className="absolute top-2 left-2 sm:top-3 sm:left-3 text-[10px] uppercase tracking-wider px-2 py-1 rounded-full" style={{ backgroundColor: "#355E4B", color: "#FFFFFF" }}>
                        {p.tag}
                      </span>
                    )}
                    {p.old && (
